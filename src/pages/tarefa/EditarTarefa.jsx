          ...
          <Grid container spacing={2} mt={1}>
            ...
            <Grid item xs={3}>  
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value={'Aguardando'} style={{ color: statusTarefa === 'Aguardando' ? 'red' : '' }}>Aguardando</MenuItem>
                  <MenuItem value={'Em Andamento'} style={{ color: statusTarefa === 'Em Andamento' ? 'orange' : '' }}>Em Andamento</MenuItem>
                  <MenuItem value={'Concluída'} style={{ color: statusTarefa === 'Concluída' ? 'green' : '' }}>Concluída</MenuItem>
                </Select>
              </FormControl>
            </Grid>
            <Grid container spacing={2} pl={2} mt={2}>
              <Grid item xs={1}>
                <Button size="small"value={'Salvar'} variant="contained" style={{ color: 'Salvar' === 'Salvar' ? 'green' : '' }} onClick={handleEditar}>Salvar</Button>
              </Grid>  
              <Grid item xs={1}>  
                <Button size="small" value={'Salvar'} variant="outlined" style={{ color: 'Salvar' === 'Salvar' ? 'red' : '' }}onClick={handleCloseEditar}>Cancelar</Button>  
              </Grid>
            </Grid>  
          </Grid>
        </CardContent>
